...
**Musik:** Pilih trending sound di TikTok/Instagram saat upload  
**Caption:** Sertakan 3-5 hashtag + link di bio  
...
## Script 2 — "Gak Nyangka"

**Hook:** "Gua gak nyangka… serius."
...
## Script 3 — "Mitos vs Fakta"

**Hook:** "Katanya main toto online itu susah menang?"
...
## Script 5 — "Pasaran Favorit"

**Hook:** "Pasaran toto favorit lo apa?"
...
| Waktu | Visual | Audio/VC |
|-------|--------|----------|
| 0–3s | Host tunjuk ke arah layar (fake testimoni style) | "Jangan percaya omongan gua. Dengerin member kita." |
| 3–10s | Screenshot chat WhatsApp/Telegram (testimoni member) — overlay text quote | Voice-over baca testimoni: "Awalnya iseng daftar, eh malah keterusan. Kemarin withdraw 15 juta, cair gak sampe 10 menit." |
| 10–16s | Screenshot kedua, testimoni berbeda | "Member lain: 'Pasaran paling lengkap deh. Saya udah coba banyak situs, balik lagi ke sini terus.'" |
...
## Script 7 — "Daily Routine"

**Hook:** "Morning routine gua sebagai player toto."
...
**Hook:** "Jangan sampe lo yang ketinggalan."

**Durasi:** 17 detik

| Waktu | Visual | Audio/VC |
|-------|--------|----------|
| 0–3s | Host on camera, tatapan serius | "Setiap hari ada yang daftar. Setiap hari ada yang menang." |
| 3–8s | Montase cepat: orang senang + screenshot withdraw | "Tapi itu bukan lo. Karena lo masih mikir-mikir." |
...
## Script 9 — "Bongkar Rahasia"

**Hook:** "Gua bongkar rahasia player pro."
...
## Script 10 — "Wrap-Up Challenge"

**Hook:** "Ini challenge buat lo."
...
| Platform | Frekuensi | Jam Terbaik |
|----------|-----------|-------------|
| TikTok | 1–2x per hari | 07:00, 12:00, 19:00 WIB |
| Instagram Reels | 1x per hari | 12:00, 20:00 WIB |

### Tips Viral

1. **Hook dalam 1 detik pertama** — langsung tarik perhatian
2. **Pakai trending audio** — algoritma prioritas konten dengan sound trending
3. **Loop-friendly** — buat video yang enak ditonton berulang (seamless loop)
4. **Reply comments** — engagement = algoritma boost
5. **Konsisten posting** — 1-2 video per hari lebih baik daripada 5 video sekaligus lalu hiatus
6. **Stitch/Duet** — manfaatkan fitur stitch/duet TikTok untuk konten reaksi
7. **Cek analytics** — evaluasi mana yang perform, double-down di style itu

---

*Script 1-10 siap produksi. Rekam dengan pencahayaan baik dan audio jernih. Edit cepat dengan pacing dinamis khas TikTok/Reels.*
